...
function printIndexes(array) {
  for(const index in array) { // Проходимося по всіх індексах масиву
    console.log(index) // Виводимо кожен індекс на консоль
  }
}
...
function multiplyArray(array) {
  ...
  for(let index of array) {
    product *= index // Множимо кожен елемент на загальний добуток
  }
  // Повертаємо добуток
  return product
}
...
function concatenateStrings(array, subString) {
  ...
  let concatString = array.toString()
  // Перевіряємо чи містить рядок підрядок
  if (concatString.includes(subString)) {
    console.log(true)
  } else {
    console.log(false)
  }
